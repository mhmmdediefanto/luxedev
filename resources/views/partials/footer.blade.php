            ...
            <div class="w-full sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12 px-4">
                <div class="w-full mb-10">
                    <a href="javascript:void(0)" class="inline-block max-w-[160px] mb-6">
                        <img src="{{ asset('storage/images/logo/logo-white.svg') }}" alt="logo" class="max-w-full" />
                    </a>
            ...
            <div class="w-full md:w-2/3 lg:w-6/12 xl:w-3/12 px-4">
                <div class="w-full mb-10">
                    ...
                    <ul class="flex flex-wrap items-center">
                      ...
                      2xl:max-w-[120px]
                    ">
                                <img src="{{ asset('storage/images/footer/brands/tailgrids.svg') }}" alt="tailgrids" />
                            </a>
                        </li>
                        <li>
                            <a href="#" rel="nofollow noopner" target="_blank"
                      ...
                      2xl:max-w-[120px]
                    ">
                                <img src="{{ asset('storage/images/footer/brands/ayroui.svg') }}" alt="ayroui" />
                            </a>
                        </li>
                        <li>
                      ...
                      2xl:max-w-[120px]
                    ">
                                <img src="{{ asset('storage/images/footer/brands/ecommerce-html.svg') }}" alt="ecommerce-html" />
                            </a>
                        </li>
                        <li>
                      ...
                      2xl:max-w-[120px]
                    ">
                                <img src="{{ asset('storage/images/footer/brands/graygrids.svg') }}" alt="graygrids" />
                            </a>
                        </li>
                        <li>
                      ...
                      2xl:max-w-[120px]
                    ">
                                <img src="{{ asset('storage/images/footer/brands/lineicons.svg') }}" alt="lineicons" />
                            </a>
                        </li>
                        <li>
                      ...
                      2xl:max-w-[120px]
                    ">
                                <img src="{{ asset('storage/images/footer/brands/uideck.svg') }}" alt="uideck" />
                            </a>
                        </li>
                    </ul>
                </div>
